...
namespace NGround {
    ...
    void TProtoSerial::operator() (TVectorD& v, int protoField) {
       switch (Mode) {
           case ESerialMode::IN:
           {
               const NGroundProto::TVectorD* vecProto = GetMessage<NGroundProto::TVectorD>(protoField);
    ...
    void TProtoSerial::operator() (TMatrixD& m, int protoField) {
       switch (Mode) {
           case ESerialMode::IN:
           {
               const NGroundProto::TMatrixD* mat = GetMessage<NGroundProto::TMatrixD>(protoField);
